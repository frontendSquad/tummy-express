                                            ...
                                            <div class="box py-3 px-5">
                                                <form class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="felid">
                                                            ...
                                                            <div class="files">
                                                                ...
                                                                <h6>Drop your image here, or <strong>browse</strong></h6>
                                                            </div>
                                                        </div>
                                                    </div> 
                                                    ...
                                                    <div class="col-md-12 mt-md-5 mt-0">
                                                        <h4 class="h2 black font-weight-bold">Description</h4>
                                                    </div>                                                    
                                                    <div class="col-md-6">
                                                        <div class="felid">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="felid mt-3 text-center">
                                                            <button type="submit" class="btnn gd-btn">Add New Product</button>
                                                        </div>
                                                    </div>                                              
                                                </form>
                                            </div>
