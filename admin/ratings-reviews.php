                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-dashboard dataTables_wrapper">
                                            <div class="d-md-flex top justify-content-md-between align-items-center mb-2">
                                                <h1 class="black">ratings-reviews</h1>
                                            </div>
                                            <div class="box px-2">   
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            <div class="reviews_left">
                                                                <h2 class="visia-text-61">3.5/5</h2>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-md-12">
                                                            <div class="reviews_bottom">
                                                                <div class="reviews_bmain d-flex flex-warp mb-5">
                                                                    <div class="reviews_bleft">
                                                                        <img src="images/card-picc1.png" class="" alt="...">
                                                                    </div>
                                                                    <div class="reviews_bright">
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                                <h5 class="h2 nunito black font-weight-bold mb-0">Mark Carson</h5>
                                                                            </div>
                                                                            <div class="col-md-3">
                                                                                <div class="rating-star">
                                                                                    <i class="fas fa-star"></i>
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                <p class="mt-0 h2 poppins mb-1 text-light">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est.</p>
                                                                            </div> 
                                                                            <div class="col-md-4">
                                                                                <div class="d-flex">
                                                                                    <h6 class="mt-0 poppins"><i class="fas fa-calendar"></i> Mm/Dd/Yyyy</h6>
                                                                                    <h6 class="mt-0 poppins ml-3"><i class="fas fa-clock"></i> 09:00 AM</h6>
                                                                                </div>
                                                                            </div>  
                                                                            <div class="col-md-8 text-sm-right">
                                                                                <a href="#" class="rdetails poppins">View Order Details</a>
                                                                            </div>                                                                   
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="reviews_bmain d-flex flex-warp mb-5">
                                                                    <div class="reviews_bleft">
                                                                        <img src="images/card-picc2.png" class="" alt="...">
                                                                    </div>
                                                                    <div class="reviews_bright">
                                                                        <div class="row">
                                                                            <div class="col-md-12">
                                                                ...
                                                                <div class="reviews_bmain d-flex flex-warp mb-5">
                                                                    <div class="reviews_bleft">
                                                                        <img src="images/card-picc3.png" class="" alt="...">
                                                                    </div>
                                                                    <div class="reviews_bright">
                                                                        <div class="row">
                                                                            <div class="col-md-12">
