                                            ...
                                            <div class="box py-3 px-5">
                                                <form class="row">
                                                    <div class="col-12">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <h4 class="h2 black font-weight-bold">Edit Category</h4>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="felid">
                                                                    <p class="text-danger mb-2">Total Number of Products: 24</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="felid">
                                                                <button type="submit" class="btnn gd-btn pl-5 pr-5">Update</button>
                                                            </div>
                                                        </div>                                              
                                                    </div>
                                                </form>
