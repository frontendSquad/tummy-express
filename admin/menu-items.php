                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-dashboard dataTables_wrapper">
                                            <div class="d-md-flex top justify-content-md-between align-items-center mb-2">
                                                <h1>Menu Items</h1>
                                                <a href="create-menu-item.php" class="btnn gd-btn">Create Menu Item</a>
                                            </div>    
                                                                                    ...
                                                                                    <td>
                                                                                        <div class="btn-group ml-1">
                                                                                            ...
                                                                                            <div class="dropdown-menu"> 
                                                                                                <a class="dropdown-item" href="product-details-active.php"><i class="fas fa-eye"></i> View</a> 
                                                                                                <a class="dropdown-item" href="edit-product.php"><i class="fas fa-pen"></i> Edit</a> 
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center"> <img src="images/inactive_img.png" class="img-fluid" alt="Check Image">
                ...
                <h6>Are you sure you want to disable this menu item?</h6>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center"> <img src="images/check_img.png" class="img-fluid" alt="Check Image">
                <h5 class="font-weight-semibold mt-2">Alert</h5>
                <h6>Menu Item has been disabled.</h6>
...
<div class="default-modal activated modal fade block-req" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body text-center"> <img src="images/check_img.png" class="img-fluid" alt="Check Image">
                <h5 class="font-weight-semibold mt-2">Alert</h5>
                <h6>Are you sure you want to activate this menu item?</h6>
                <button class="white-btn" data-toggle="modal" data-target=".activated2" data-dismiss="modal" aria-label="Close">yes</button> 
                <button class="gd-btn ml-2" data-dismiss="modal" aria-label="Close">no</button> 
            </div>
        </div>
    </div>
...
<div class="default-modal activated2 modal fade block-req" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <i aria-hidden="true" class="fa fa-times"></i> </button>
            <div class="modal-body text-center"> <img src="images/check_img.png" class="img-fluid" alt="Check Image">
                <h5 class="font-weight-semibold mt-2">Alert</h5>
                <h6>Product activated successfully!</h6>
                <button class="gd-btn" data-dismiss="modal" aria-label="Close">Ok</button> 
            </div>
        </div>
    </div>
