    ...
    <div class="content-wrapper">
        <div class="content-body">
            ...
            <section id="configuration" class="my-profile">
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex flex-md-row flex-column border-bottom mb-3">
                            <h3 class="mb-2 page-main-hdng pr-2"> <i onclick="javascript:history.go(-1)" class="far fa-long-arrow-left"></i> Order Details</h3>
                            <h4 class="border-left font-weight-normal headingh4 pl-2 text-info">Received Orders</h4>
                        </div>
                    </div>
                </div>
                <div class="row">
