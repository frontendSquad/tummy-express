            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex flex-md-row flex-column justify-content-between border-bottom mb-3">
                        <h3 class="mb-2 page-main-hdng">Reported Orders</h3>
                        <!--     -->
                    </div>
                    <div class="d-flex flex-md-row flex-column justify-content-between">
                        <h2 class="prmry-hdng mb-3">Reported Order Log</h2>
                    </div>
                </div>
            </div>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group ml-1">
                                                                        ...
                                                                        Pending <i class="fas fa-sort-down"></i>
                                                                        </button>
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item" href="#">Resolved</a>
                                                                            <a class="dropdown-item" data-toggle="modal" data-target=".activeModal">Reject</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="btn-group ml-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item" href="reported-order-details.php"><i class="fa pr-1 fa-eye"></i> View Order</a>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group ml-1">
                                                                        ...
                                                                        Resolved <i class="fas fa-sort-down"></i>
                                                                        </button>
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item" href="#">Resolved</a>
                                                                            <a class="dropdown-item" data-toggle="modal" data-target=".activeModal">Reject</a>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group ml-1">
                                                                        <button type="button" class="dropdown-toggle text-danger" data-toggle="dropdown">
                                                                        Reject <i class="fas fa-sort-down"></i>
                                                                        </button>
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item" href="#">Resolved</a>
                                                                            <a class="dropdown-item" data-toggle="modal" data-target=".activeModal">Reject</a>
