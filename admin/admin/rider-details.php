                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex flex-md-row flex-column justify-content-between border-bottom mb-3">
                            <h3 class="mb-2 page-main-hdng"> Rider Details</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                                    ...
                                    <div class="row justify-content-between border-bottom pb-3">
                                                ...
                                                <div class="media-body pl-0">
                                                    <div class="row detail-row d-flex align-items-start">
                                                        ...
                                                        <div class="col-xl-8 col-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-6 col-sm-12 ">
                                                                    <p class="">Driving License No.</p>
                                                                </div>
                                                                <div class="col-md-6 col-sm-12 ">
                                                                    <p class="color-gray">License123</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-12 col-lg-4 col-md-12">
                                            <div class="">
                                                ...
                                                <p class="color-gray text-info"><i class="fas fa-download text-info pr-1"></i> Driving License PDF</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="restaurants_logs">
                                                        <h2 class="prmry-hdng mb-3">Order Information</h2>
                                                    </div>
                                                    <table class="table table-borderless dataTable">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="">Delivery Amount Paid <i class="fas fa-sort"></i></th>
...
<div class="modal fade delivered p-0" tabindex="" role="" aria-labelledby="" aria-hidden="true" data-backdrop="static">
...
<div class="modal fade inprocess p-0" tabindex="" role="" aria-labelledby="" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"></h5>
