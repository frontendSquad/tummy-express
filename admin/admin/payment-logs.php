            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex flex-md-row flex-column justify-content-between border-bottom mb-3">
                        <div class="d-flex">
                            <h3 class="mb-2 page-main-hdng pr-3">Payment Logs</h3>
                            <h4 class="border-left font-weight-normal headingh4 pl-2 text-info">Total Orders for this month: 30</h4>
                        </div>
                        <div>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group ml-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item" href="riders-payment-logs.php"><i class="fa pr-1 fa-eye"></i> View</a>
