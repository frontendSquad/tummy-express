            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex flex-md-row flex-column justify-content-between border-bottom mb-3">
                        <h3 class="mb-2 page-main-hdng">Riders Logs</h3>
                        <!--     -->
                    </div>
                </div>
            </div>
                        ...
                        <div class="page-title">
                            <div class="row user-listing-top ">
                                ...
                                <div class="col-12 col-md-12 col-lg-6 col-xl-6 mt-2 mt-md-0">
                                    <div class="d-flex flex-md-row flex-column justify-content-lg-end">
                                        <div class="alertbox">
                                            <a href="new-rider-sign-up-request.php"><p>New Restaurant Sign Up Request <span>9+</span></p></a>
                                        </div>
                                    </div>                                    
                                </div>
                                                    ...
                                                    <table class="table table-borderless dataTable">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="">Availibility <i class="fas fa-sort"></i></th>
                                                                <th class="">Total Orders Delivered <i class="fas fa-sort"></i></th>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group ml-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item" href="rider-details.php"><i class="fa pr-1 fa-eye"></i> View</a>
                ...
                <form action="login.php" method="post">
                    <div class="row">
                        <div class="col-12 text-left">
                            ...
                            <p>Are You Sure You Want To activate This Riders?</p>
                ...
                <form action="login.php" method="post">
                    <div class="row">
                        <div class="col-12 text-left">
                            ...
                            <h5 class="text-left font-weight-semibold text-danger">Alert</h5>
							<p>Are You Sure You Want To Inactivate This Riders?</p>
                            <div class="modal-buttons mt-3">
