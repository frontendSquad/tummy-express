            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex flex-md-row flex-column justify-content-between border-bottom mb-3">
                        <h3 class="mb-2 page-main-hdng">Promo Code Management</h3>
                        <div>
                            <a href="#" class="btn btn-primary mr-1" data-target=".send_promo" data-toggle="modal">Send Promo Code to User</a>
                            <a href="#" class="btn btn-primary" data-target=".add_promo" data-toggle="modal">Add More Promo</a>
                        </div>
                    </div>
                </div>
            </div>
                                                                ...
                                                                <td>
                                                                    <div class="btn-group ml-1">
                                                                        ...
                                                                        <div class="dropdown-menu">
                                                                            <a class="dropdown-item" href="#"><i class="fa pr-1 fa-eye"></i> View Order</a>
                                                                            <a class="dropdown-item" href="#"><i class="fas pr-1i fa-pencil-alt"></i> Edit</a>
                    ...
                    <div class="row">
                        <div class="col-12 text-left">
                            ...
                            <div class="felid d-inline-block mb-2">
                                <label class="felidlab pt-0 pl-3">Send through Notification
                                  <input type="radio" name="radio">
                                  <span class="checkmark"></span>
                                </label> 
                            </div>
                            <div class="felid d-inline-block mb-2 pl-2">
                                <label class="felidlab pt-0 pl-3">Send through Email
...
<div class="modal fade add_promo p-0" tabindex="" role="" aria-labelledby="" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"></h5>
            ...
            <div class="modal-body">
                <form action="login.php" method="post">
                    <div class="row">
                        <div class="col-12 text-left">
                            <h5 class="font-weight-semibold text-left color-gray mb-2">Add Promo Code</h5>
                            <div class="felid d-inline-block mb-2">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <input type="text" name="" placeholder="Promo Name">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" name="" placeholder="12/12/12">
                                </div>
                            </div>  
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <input type="text" name="" placeholder="Discount">
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <input type="text" name="" placeholder="Valid Till">
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="modal-buttons">
                                <button type="button" class="btn btn-primary mr-1" data-dismiss="modal" aria-label="Close" data-toggle="modal" data-target=".add_promo2">Refund</button>
                                <button type="submit" class="btn btn-secondary ml-1 cancel-btn" data-dismiss="modal" aria-label="Close">Cancel</button>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade add_promo2 p-0" tabindex="" role="" aria-labelledby="" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"></h5>
                ...
                <form action="login.php" method="post">
                    <div class="row">
                        <div class="col-12 text-left">
                            ...
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <input type="text" name="" placeholder="Promo Abc">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" name="" placeholder="12/12/12">
                                </div>
                            ...
                            <div class="row mb-2">
                                ...
                                <div class="col-md-6">
                                    <input type="text" name="" placeholder="Discount2134">
                                </div>
                            </div> 
                            <div class="row mb-2">
                                <div class="col-md-6">
                                    <input type="text" name="" placeholder="09/12/21">
                                </div>
                                <div class="col-md-6">
                                    <div class="checkbox switcher">
                                      <label for="test">
