                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex flex-md-row flex-column justify-content-between border-bottom mb-3">
                            <h3 class="mb-2 page-main-hdng">Rider</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                                                    ...
                                                    <div class="row detail-row d-flex align-items-start">
                                                        ...
                                                        <div class="col-xl-8 col-12">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-6 col-sm-12 ">
                                                                    <p class="color-gray">License 123</p>
                                                                </div>
                                                            </div>
                                                            <div class="row mt-3">
                                                                <div class="col-md-12 col-sm-12">
                                                                    <a href="rider-request-approved.php" class="btn-green mr-1">Accept</a>
                                                                    <a href="rider-request-rejected.php" class="btn-red">Reject</a>
                                                                </div>                                                                
                                                            </div>
                                                        </div>
                                                    </div>
